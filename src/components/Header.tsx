    ...
    <header className="fixed top-0 w-full bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 shadow-xl border-b border-blue-700 z-50">
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <a href='https://github.com/JDiego199/Codigo-TFM' target="_blank">
                        <svg color='white' height="28" aria-hidden="true" viewBox="0 0 24 24" version="1.1" width="28" data-view-component="true"  className="fill-current">
